---
title: 'Jakie dokumenty są potrzebne do pochówku i budowy pomnika?'
date: '11-07-2026 10:00'
taxonomy:
    category:
        - 'Poradnik'
    tag:
        - 'formalności pogrzebowe dokumenty'
        - 'zgoda na postawienie pomnika'
        - 'wniosek o wymianę pomnika'
seo_title: Formalności pogrzebowe i montaż nagrobka – jakie dokumenty?'
meta_description: 'Przygotowanie do pochówku i budowy pomnika wiąże się z szeregiem urzędowych formalności. Sprawdź nasz poradnik i dowiedz się, jak Kamieniarstwo Wiśniewski wyręczy Cię w biurokracji.'
published: true
visible: false
hero_image: article.jpg
hero_overlay: 45
main_image: formalnosci-pochowek.jpg
hero_subtitle: 'Kamieniarstwo Wiśniewski pomoże z dokumentami.'
hero_buttons:
    -
        text: 'Oferta pomników'
        url: '/produkty'
        class: btn-secondary
    -
...
Zanim w ogóle udamy się do zarządu cmentarza lub kancelarii parafialnej, jeśli mówimy o cmentarzu wyznaniowym, musimy przejść przez pierwszy, najważniejszy etap, czyli uzyskanie Aktu zgonu. Aby go otrzymać, z dokumentem od lekarza, tzw. kartą zgonu, oraz dowodem osobistym zmarłego musimy udać się do Urzędu Stanu Cywilnego (USC) właściwego dla miejsca zgonu bliskiej nam osoby.
